...
var (
	...
	// HexRootHash1 defines a flag for the shard 0 trie root hash expressed in hex format
	HexRootHash1 = cli.StringFlag{
		Name:  "hex-roothash-1",
		Usage: "This flag specifies the roothash to start the checking from",
		Value: "",
	}
	// HexRootHash2 defines a flag for the shard 0 trie root hash expressed in hex format
	HexRootHash2 = cli.StringFlag{
		Name:  "hex-roothash-2",
		Usage: "This flag specifies the roothash to start the checking from",
		Value: "",
	}
	// HexRootHashMeta defines a flag for the shard 0 trie root hash expressed in hex format
