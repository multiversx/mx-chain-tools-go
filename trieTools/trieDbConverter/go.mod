module github.com/ElrondNetwork/mx-chain-tools-go/trieTools/trieDbConverter

go 1.23.7

require (
	github.com/multiversx/mx-chain-core-go v1.4.2-0.20260219091525-015123fd1603
	github.com/multiversx/mx-chain-go v1.11.2-0.20260319102557-8eab550197c3
	github.com/multiversx/mx-chain-logger-go v1.1.0
	github.com/multiversx/mx-chain-tools-go/trieTools v0.0.0-20251215081238-b169488bba14
